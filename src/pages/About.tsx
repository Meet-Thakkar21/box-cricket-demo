...
export const About = () => {
  return (
    <div className="flex flex-col min-h-screen bg-light-900">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-display font-extrabold text-light-text tracking-tight mb-4"
          >
          ...
          <motion.p 
            ...
            className="text-xl text-light-muted max-w-2xl mx-auto"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div 
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl md:text-4xl font-display font-bold text-light-text">
              ...
              <ul className="space-y-4 mt-8">
                {[
                  ...
                  <li key={i} className="flex items-center space-x-3">
                    <div className="p-2 bg-gray-50 rounded-lg border border-light-600 shadow-sm">
                      {item.icon}
                    </div>
                    <span className="text-light-text font-medium">{item.text}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="relative h-[500px] rounded-2xl overflow-hidden bg-white shadow-xl p-2 border border-light-600"
            >
              <img 
                src="/arena.png" 
      ...
      <section className="py-20 bg-gray-50 border-t border-light-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-display font-bold text-light-text mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              ...
              className="rounded-2xl overflow-hidden border border-light-600 shadow-md bg-white"
            >
